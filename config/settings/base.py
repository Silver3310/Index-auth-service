...
)  # (index_auth_service/config/settings/base.py - 3 = index_auth_service/)
APPS_DIR = ROOT_DIR.path("index_auth_service")
...
MIGRATION_MODULES = {"sites": "index_auth_service.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "index_auth_service.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "index_auth_service.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
